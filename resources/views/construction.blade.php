                ...
                <div class="full-wrapper relative clearfix">
                    ...
                    <div class="inner-nav desktop-nav">
                        <ul class="clearlist scroll-nav local-scroll">
                            <li class="active"><a href="mailto:waruq@outlook.co"><i class="fa fa-envelope"></i> waruq@outlook.com</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i>+91 9596403091</a></li>
                ...
                <div class="container">
                    ...
                    <div class="footer-text">
                        ...
                        <div class="footer-copy font-alt">
                            <a href="#" target="_blank">&copy; Waruq 2017</a>.
                        </div>
                        <!-- End Copyright -->
