...
<html>
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <!-- Home Section -->
            <section class="home-section bg-dark-alfa-90 parallax-2" data-background="images/full-width-images/section-bg-4.jpg" id="home">
                    ...
                    <div class="row multi-columns-row"> -->
                       ...
                       <!--  <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.1s" data-wow-duration="2s">
                            ...
                            <div class="post-prev-title font-alt">
                                <a href="default.htm">New Web Design Trends</a>
                            </div>
                            
                            <div class="post-prev-info font-alt">
                                <a href="default.htm">John Doe</a> | 10 December
                            </div>
                     ...
                     <!--    <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                            ...
                            <div class="post-prev-title font-alt">
                                <a href="default.htm">Minimalistic Design Forever</a>
                            </div>
                            
                            <div class="post-prev-info font-alt">
                                <a href="default.htm">John Doe</a> | 9 December
                            </div>
                     ...
                     <!--    <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.3s" data-wow-duration="2s">
                            ...
                            <div class="post-prev-title font-alt">
                                <a href="default.htm">Hipster&rsquo;s Style in&nbsp;Web</a>
                            </div>
                            
                            <div class="post-prev-info font-alt">
                                <a href="default.htm">John Doe</a> | 7 December
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-4 pt-20 pb-20 pb-xs-0">
                                    <div class="contact-item">
                                        ...
                                        <div class="ci-text">
                                            <a href="mailto:waruq@outlook.com">info@waruq.com</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Email -->
